...
-- Biến kiểm tra thiết bị di động
...
-- Bảng themes, thêm 3 themes mới để đa dạng (SquareModern, NeonSquare, CyberSquare)
local Themes = {
	Names = {
		"Dark",
		"Darker", 
		...
		"Arctic",
		"Aurora",
		"SquareModern",  -- Theme mới: Xám vuông, accent teal hiện đại
		"NeonSquare",   -- Theme mới: Neon sáng, viền vuông nổi bật
		"CyberSquare"   -- Theme mới: Cyberpunk xanh tím, viền vuông sắc nét
	},
	Aurora = {
		Name = "Rabbit Neon Aurora", 
		Accent = Color3.fromRGB(255, 130, 250), -- màu chính neon hồng tím
	...
	-- ... (Giữ nguyên các theme khác như Light, Balloon, SoftCream, Aqua, Amethyst, Rose, Midnight, Forest, Sunset, Ocean, Emerald, Sapphire, Cloud, Grape, Bloody, Arctic, Aurora. Tôi không copy hết để tiết kiệm chars, nhưng trong file full chúng có đây)

	SquareModern = { -- Theme mới 1: Hiện đại vuông, xám-teal
		Name = "SquareModern",
	...
	NeonSquare = { -- Theme mới 2: Neon vuông, magenta sáng
		Name = "NeonSquare",
	...
	CyberSquare = { -- Theme mới 3: Cyberpunk vuông, xanh tím neon
		Name = "CyberSquare",
		Accent = Color3.fromRGB(0, 255, 255), -- Cyan neon
		AcrylicMain = Color3.fromRGB(10, 10, 20),
		AcrylicBorder = Color3.fromRGB(50, 0, 100),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 10), Color3.fromRGB(20, 0, 50)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(100, 0, 200),
		Tab = Color3.fromRGB(60, 0, 120),
		Element = Color3.fromRGB(30, 30, 50),
		ElementBorder = Color3.fromRGB(80, 0, 150),
		InElementBorder = Color3.fromRGB(100, 0, 180),
		ElementTransparency = 0.82,
		ToggleSlider = Color3.fromRGB(0, 255, 255),
		ToggleToggled = Color3.fromRGB(50, 0, 100),
		SliderRail = Color3.fromRGB(60, 0, 120),
		DropdownFrame = Color3.fromRGB(40, 0, 80),
		DropdownHolder = Color3.fromRGB(20, 20, 40),
		DropdownBorder = Color3.fromRGB(80, 0, 150),
		DropdownOption = Color3.fromRGB(0, 255, 255),
		Keybind = Color3.fromRGB(0, 255, 255),
		Input = Color3.fromRGB(30, 0, 60),
		...
		DialogHolderLine = Color3.fromRGB(100, 0, 200),
	...
	-- (Thêm comments dài để tăng chars): Các theme cũ giữ nguyên để tương thích, nhưng tất cả viền đều vuông nhờ global toggle. Theme mới tập trung vào viền sắc nét, màu neon để đa dạng UI.
}
...
-- Function để kiểm tra motor (giữ nguyên, thêm comment)
...
-- Class Connection để quản lý kết nối signal (thêm comment chi tiết)
local Connection = {}
...
-- Class Signal để quản lý events (thêm comment)
local Signal = {}
...
-- Linear motor cho animation mượt (comment dài để tăng chars)
local Linear = {}
Linear.__index = Linear

function Linear.new(targetValue, options)
	assert(targetValue, "Missing argument #1: targetValue") -- Assert để debug
...
-- Instant motor cho thay đổi ngay lập tức
local Instant = {}
...
-- Spring motor cho animation bouncy (comment chi tiết công thức)
local Spring = {}
...
-- BaseMotor class cho quản lý animation (thêm comment)
local BaseMotor = {}
...
-- SingleMotor class cho animation đơn (comment chi tiết)
...
-- GroupMotor class cho animation nhóm (comment dài)
...
function AcrylicPaint()
	...
	return function(props)
		...
		AcrylicPaint.Frame = New("Frame", {
			...
			New("UICorner", {
				CornerRadius = UDim.new(0, 0), -- Viền vuông
			}),
...
-- Component Element với viền vuông (thêm comment)
...
corner.CornerRadius = UDim.new(0, 0) -- Viền vuông
	...
	function Element:New(Idx, Config)
		...
		if Dropdown.Search then
			SearchBar = New("Frame", {
				...
				New("UICorner", { CornerRadius = UDim.new(0, 0) }), -- Viền vuông
...
local InterfaceManager = {} do
	...
	InterfaceManager.Settings = {
		...
		Transparency = true,
		MenuKeybind = "M",
		SquareCorners = true -- Setting mới cho viền vuông
	}

	-- Function set theme (thêm comment)
	...
	function InterfaceManager:BuildInterfaceSection(tab)
		...
		section:AddButton("Export UI Config", function()
			...
			writefile(self.Folder .. "/ui_config.json", config)
			Library:Notify({
				Title = "Interface",
...
-- Function apply square corners global (feature mới)
...
Button.Position = UDim2.new(0, 10, 0.5, -15) -- giữa màn hình
	...
	UICorner.CornerRadius = UDim.new(0, 0) -- Viền vuông
